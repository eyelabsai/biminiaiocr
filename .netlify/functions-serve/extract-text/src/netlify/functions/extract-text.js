...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    let imageData = requestBody.image;
    if (!imageData) {
      return {
        statusCode: 400,
    ...
    return {
      statusCode: 500,
      body: JSON.stringify({ error: "Error processing image: " + error.message })
    };
  }
};
